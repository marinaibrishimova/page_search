...
class CI_Form_validation {
	...
	/**
	 * Valid Alpha-Numeric with Spaces
	 *
	 * @access	public
	 * @param	string
	 * @return	bool
	...
	function alpha_spaces($str)
	{
		...
		$entry = htmlspecialchars($str);
						
		 $fromspace = " ";
		 $toone="1"; 
   	    	
   		 //find and replace from_substring with to_substring
	         $check = strtr($entry, $fromspace, $toone);
	...
	function num_dot($str)
	{
		...
		$entry = htmlspecialchars($str);
		 ...
		 $toone="1"; 
   		 ...
   		 //find and replace from_substring with to_substring
	         $check = strtr($entry, $fromdot, $toone);
